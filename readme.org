...
#+RESULTS:
: [nil 26848 6562 45580 nil #[nil ((if (emacs-rag-server-running-p) (message "Emacs RAG server started successfully") (message "Warning: Server may not have started properly"))) (t)] nil nil 0 nil]
...
#+RESULTS:
: [nil 26848 10958 638265 nil #[nil ((if (emacs-rag-server-running-p) (message "Emacs RAG server started successfully") (message "Warning: Server may not have started properly"))) (t)] nil nil 0 nil]
...
(setq emacs-rag-indexed-extensions '("org" "md" "txt"))
